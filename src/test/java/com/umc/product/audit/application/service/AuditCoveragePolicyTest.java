...
class AuditCoveragePolicyTest {
    ...
    private static List<AuditSpec> auditedSpecs() {
        ...
        return List.of(
            ...
            spec("inhouse.application.service.UmcProductChapterCommandService", "create", "INHOUSE", "CREATE", "UmcProductChapter", type("inhouse.application.port.in.command.dto.CreateUmcProductChapterCommand")),
            spec("inhouse.application.service.UmcProductChapterCommandService", "update", "INHOUSE", "UPDATE", "UmcProductChapter", type("inhouse.application.port.in.command.dto.UpdateUmcProductChapterCommand")),
            spec("inhouse.application.service.UmcProductChapterCommandService", "delete", "INHOUSE", "DELETE", "UmcProductChapter", longType, longType),
            spec("inhouse.application.service.UmcProductMemberCommandService", "create", "INHOUSE", "CREATE", "UmcProductMember", type("inhouse.application.port.in.command.dto.CreateUmcProductMemberCommand")),
            spec("inhouse.application.service.UmcProductMemberCommandService", "updateProfile", "INHOUSE", "UPDATE", "UmcProductMember", type("inhouse.application.port.in.command.dto.UpdateUmcProductMemberProfileCommand")),
            spec("inhouse.application.service.UmcProductMemberCommandService", "delete", "INHOUSE", "DELETE", "UmcProductMember", longType, longType),
            spec("inhouse.application.service.UmcProductMemberCommandService", "createActivityPeriod", "INHOUSE", "CREATE", "UmcProductMemberActivityPeriod", type("inhouse.application.port.in.command.dto.CreateUmcProductMemberActivityPeriodCommand")),
            spec("inhouse.application.service.UmcProductMemberCommandService", "updateActivityPeriod", "INHOUSE", "UPDATE", "UmcProductMemberActivityPeriod", type("inhouse.application.port.in.command.dto.UpdateUmcProductMemberActivityPeriodCommand")),
            spec("inhouse.application.service.UmcProductMemberCommandService", "deleteActivityPeriod", "INHOUSE", "DELETE", "UmcProductMemberActivityPeriod", longType, longType, longType),
            spec("inhouse.application.service.UmcProductMemberCommandService", "createChapterMembership", "INHOUSE", "CREATE", "UmcProductChapterMembership", type("inhouse.application.port.in.command.dto.CreateUmcProductChapterMembershipCommand")),
            spec("inhouse.application.service.UmcProductMemberCommandService", "updateChapterMembership", "INHOUSE", "UPDATE", "UmcProductChapterMembership", type("inhouse.application.port.in.command.dto.UpdateUmcProductChapterMembershipCommand")),
            spec("inhouse.application.service.UmcProductMemberCommandService", "deleteChapterMembership", "INHOUSE", "DELETE", "UmcProductChapterMembership", longType, longType, longType),
