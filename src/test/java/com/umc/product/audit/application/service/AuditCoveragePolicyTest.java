...
class AuditCoveragePolicyTest {
    ...
    private static List<AuditSpec> auditedSpecs() {
        ...
        return List.of(
            ...
            spec("inhouse.application.service.UmcProductChapterCommandService", "create", "ORGANIZATION", "CREATE", "UmcProductChapter", type("inhouse.application.port.in.command.dto.CreateUmcProductChapterCommand")),
            spec("inhouse.application.service.UmcProductChapterCommandService", "update", "ORGANIZATION", "UPDATE", "UmcProductChapter", type("inhouse.application.port.in.command.dto.UpdateUmcProductChapterCommand")),
            spec("inhouse.application.service.UmcProductChapterCommandService", "delete", "ORGANIZATION", "DELETE", "UmcProductChapter", longType, longType),
            spec("inhouse.application.service.UmcProductMemberCommandService", "create", "ORGANIZATION", "CREATE", "UmcProductMember", type("inhouse.application.port.in.command.dto.CreateUmcProductMemberCommand")),
            spec("inhouse.application.service.UmcProductMemberCommandService", "updateProfile", "ORGANIZATION", "UPDATE", "UmcProductMember", type("inhouse.application.port.in.command.dto.UpdateUmcProductMemberProfileCommand")),
            spec("inhouse.application.service.UmcProductMemberCommandService", "delete", "ORGANIZATION", "DELETE", "UmcProductMember", longType, longType),
            spec("inhouse.application.service.UmcProductMemberCommandService", "createActivityPeriod", "ORGANIZATION", "CREATE", "UmcProductMemberActivityPeriod", type("inhouse.application.port.in.command.dto.CreateUmcProductMemberActivityPeriodCommand")),
            spec("inhouse.application.service.UmcProductMemberCommandService", "updateActivityPeriod", "ORGANIZATION", "UPDATE", "UmcProductMemberActivityPeriod", type("inhouse.application.port.in.command.dto.UpdateUmcProductMemberActivityPeriodCommand")),
            spec("inhouse.application.service.UmcProductMemberCommandService", "deleteActivityPeriod", "ORGANIZATION", "DELETE", "UmcProductMemberActivityPeriod", longType, longType, longType),
            spec("inhouse.application.service.UmcProductMemberCommandService", "createChapterMembership", "ORGANIZATION", "CREATE", "UmcProductChapterMembership", type("inhouse.application.port.in.command.dto.CreateUmcProductChapterMembershipCommand")),
            spec("inhouse.application.service.UmcProductMemberCommandService", "updateChapterMembership", "ORGANIZATION", "UPDATE", "UmcProductChapterMembership", type("inhouse.application.port.in.command.dto.UpdateUmcProductChapterMembershipCommand")),
            spec("inhouse.application.service.UmcProductMemberCommandService", "deleteChapterMembership", "ORGANIZATION", "DELETE", "UmcProductChapterMembership", longType, longType, longType),
            spec("inhouse.application.service.UmcProductMemberCommandService", "createLeadership", "ORGANIZATION", "CREATE", "UmcProductLeadership", type("inhouse.application.port.in.command.dto.CreateUmcProductLeadershipCommand")),
            spec("inhouse.application.service.UmcProductMemberCommandService", "updateLeadership", "ORGANIZATION", "UPDATE", "UmcProductLeadership", type("inhouse.application.port.in.command.dto.UpdateUmcProductLeadershipCommand")),
            spec("inhouse.application.service.UmcProductMemberCommandService", "deleteLeadership", "ORGANIZATION", "DELETE", "UmcProductLeadership", longType, longType, longType),
            spec("inhouse.application.service.UmcProductSquadCommandService", "create", "ORGANIZATION", "CREATE", "UmcProductSquad", type("inhouse.application.port.in.command.dto.CreateUmcProductSquadCommand")),
            spec("inhouse.application.service.UmcProductSquadCommandService", "update", "ORGANIZATION", "UPDATE", "UmcProductSquad", type("inhouse.application.port.in.command.dto.UpdateUmcProductSquadCommand")),
            spec("inhouse.application.service.UmcProductSquadCommandService", "delete", "ORGANIZATION", "DELETE", "UmcProductSquad", longType, longType),
            spec("inhouse.application.service.UmcProductSquadCommandService", "createParticipant", "ORGANIZATION", "CREATE", "UmcProductSquadParticipant", type("inhouse.application.port.in.command.dto.CreateUmcProductSquadParticipantCommand")),
            spec("inhouse.application.service.UmcProductSquadCommandService", "updateParticipant", "ORGANIZATION", "UPDATE", "UmcProductSquadParticipant", type("inhouse.application.port.in.command.dto.UpdateUmcProductSquadParticipantCommand")),
            spec("inhouse.application.service.UmcProductSquadCommandService", "deleteParticipant", "ORGANIZATION", "DELETE", "UmcProductSquadParticipant", longType, longType, longType),
