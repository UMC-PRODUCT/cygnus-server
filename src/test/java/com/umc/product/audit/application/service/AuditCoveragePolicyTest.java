...
class AuditCoveragePolicyTest {
    ...
    private static List<AuditSpec> auditedSpecs() {
        ...
        return List.of(
            ...
            spec("organization.application.service.UmcProductPartCommandService", "create", "ORGANIZATION", "CREATE", "UmcProductPart", type("organization.application.port.in.command.dto.CreateUmcProductPartCommand")),
            spec("organization.application.service.UmcProductPartCommandService", "update", "ORGANIZATION", "UPDATE", "UmcProductPart", type("organization.application.port.in.command.dto.UpdateUmcProductPartCommand")),
            spec("organization.application.service.UmcProductPartCommandService", "delete", "ORGANIZATION", "DELETE", "UmcProductPart", longType, longType),
            ...
            spec("organization.application.service.UmcProductMemberCommandService", "createPartMembership", "ORGANIZATION", "CREATE", "UmcProductPartMembership", type("organization.application.port.in.command.dto.CreateUmcProductPartMembershipCommand")),
            spec("organization.application.service.UmcProductMemberCommandService", "updatePartMembership", "ORGANIZATION", "UPDATE", "UmcProductPartMembership", type("organization.application.port.in.command.dto.UpdateUmcProductPartMembershipCommand")),
            spec("organization.application.service.UmcProductMemberCommandService", "deletePartMembership", "ORGANIZATION", "DELETE", "UmcProductPartMembership", longType, longType, longType),
