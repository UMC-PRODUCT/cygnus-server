...
public record AdminOperationsAttendancePartsQuery(
    ...
    public static AdminOperationsAttendancePartsQuery of(
        Long requesterMemberId,
        Long gisuId,
        Instant from,
        Instant to
        ...
        return new AdminOperationsAttendancePartsQuery(requesterMemberId, gisuId, normalizedFrom, normalizedTo);
    }
}
