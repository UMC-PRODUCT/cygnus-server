...
public record AdminOperationsAttendanceChaptersQuery(
    ...
    public static AdminOperationsAttendanceChaptersQuery of(
        Long requesterMemberId,
        Long gisuId,
        Instant from,
        Instant to
        ...
        return new AdminOperationsAttendanceChaptersQuery(requesterMemberId, gisuId, normalizedFrom, normalizedTo);
    }
}
