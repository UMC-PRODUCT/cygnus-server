...
public class UmcProductSquad extends BaseEntity {
    ...
    private static void validate(String code, String name) {
        if (code == null || code.isBlank()) {
            throw new InhouseDomainException(InhouseErrorCode.UMC_PRODUCT_SQUAD_CODE_REQUIRED);
        }
        if (name == null || name.isBlank()) {
            throw new InhouseDomainException(InhouseErrorCode.UMC_PRODUCT_SQUAD_NAME_REQUIRED);
        }
    }
