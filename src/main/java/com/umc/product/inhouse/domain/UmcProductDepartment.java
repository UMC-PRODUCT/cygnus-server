...
@Table(name = "umc_product_department")
public class UmcProductDepartment extends BaseEntity {
    ...
    public static UmcProductDepartment create(
        String code,
        String name,
        String description,
        LocalDate startDate,
        ...
        return UmcProductDepartment.builder()
            .code(code)
            .name(name)
    ...
    private static void validate(String code, String name) {
        if (code == null || code.isBlank()) {
            throw new InhouseDomainException(InhouseErrorCode.UMC_PRODUCT_DEPARTMENT_CODE_REQUIRED);
        }
        if (name == null || name.isBlank()) {
            throw new InhouseDomainException(InhouseErrorCode.UMC_PRODUCT_DEPARTMENT_NAME_REQUIRED);
        }
    }
