...
public record CreateUmcProductDepartmentParticipantRequest(
    ...
    public CreateUmcProductDepartmentParticipantCommand toCommand(Long departmentId, Long requesterMemberId) {
