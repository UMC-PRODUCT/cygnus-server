...
public enum InhouseErrorCode implements BaseCode {
    ...
    UMC_PRODUCT_SQUAD_REQUIRED(HttpStatus.BAD_REQUEST, "INHOUSE-0008", "UMC PRODUCT Squad는 필수입니다."),
    UMC_PRODUCT_SQUAD_NOT_FOUND(HttpStatus.NOT_FOUND, "INHOUSE-0009", "UMC PRODUCT Squad를 찾을 수 없습니다."),
    UMC_PRODUCT_SQUAD_CODE_REQUIRED(HttpStatus.BAD_REQUEST, "INHOUSE-0010", "UMC PRODUCT Squad 코드는 필수입니다."),
    UMC_PRODUCT_SQUAD_NAME_REQUIRED(HttpStatus.BAD_REQUEST, "INHOUSE-0011", "UMC PRODUCT Squad 이름은 필수입니다."),
    ...
    UMC_PRODUCT_SQUAD_PARTICIPANT_NOT_FOUND(HttpStatus.NOT_FOUND, "INHOUSE-0030",
        "UMC PRODUCT Squad 참여 이력을 찾을 수 없습니다."),
    UMC_PRODUCT_SQUAD_PARTICIPATION_OVERLAPPED(HttpStatus.CONFLICT, "INHOUSE-0031",
        "동일 멤버의 UMC PRODUCT Squad 참여 기간이 겹칩니다."),
    UMC_PRODUCT_SQUAD_LEAD_OVERLAPPED(HttpStatus.CONFLICT, "INHOUSE-0032",
        "해당 기간에 이미 UMC PRODUCT Squad Lead가 존재합니다."),
    UMC_PRODUCT_SQUAD_HAS_PARTICIPANTS(HttpStatus.CONFLICT, "INHOUSE-0033",
        "연결된 참여 이력이 있어 UMC PRODUCT Squad를 삭제할 수 없습니다."),
    UMC_PRODUCT_SQUAD_ALREADY_EXISTS(HttpStatus.CONFLICT, "INHOUSE-0034", "이미 존재하는 UMC PRODUCT Squad 코드입니다.");
