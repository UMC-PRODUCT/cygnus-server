...
public class SchoolPermissionEvaluator implements ResourcePermissionEvaluator {
    ...
    public boolean evaluate(SubjectAttributes subjectAttributes, ResourcePermission resourcePermission) {
        return switch (resourcePermission.permission()) {
            case WRITE -> evaluate(OrganizationPolicyAction.SCHOOL_CREATE, subjectAttributes);
            case EDIT -> evaluate(OrganizationPolicyAction.SCHOOL_UPDATE, subjectAttributes);
            case DELETE -> evaluate(OrganizationPolicyAction.SCHOOL_DELETE, subjectAttributes);
