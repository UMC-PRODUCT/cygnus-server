...
`organization` models UMC structure: school, global chapter, gisu, and study group.
...
| Persistence | `adapter/out/persistence/{chapter,gisu,school,studygroup}` | one adapter/query repository family per subdomain |
