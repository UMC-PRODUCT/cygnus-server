...
public interface GetVoteUseCase {
     ...
     * @return 투표 상세 정보 DTO
     */
    VoteInfo getVoteInfo(FormOwnerReference expectedOwner, FormActorContext actorContext);
     ...
     */
    Long getPrimaryQuestionId(FormOwnerReference expectedOwner, FormActorContext actorContext);
}
