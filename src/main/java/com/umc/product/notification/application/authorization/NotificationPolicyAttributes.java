...
public final class NotificationPolicyAttributes {
    ...
    public static final PolicyAttributeKey<PolicyValue.BooleanValue> TOKEN_OWNER =
        new PolicyAttributeKey<>("relation.isTokenOwner", PolicyValueType.BOOLEAN);

    private NotificationPolicyAttributes() {
    }
}
